...
from pydamain.domain.messages.main import PublicEvent, public_event
...
class TestPublicEvent:
    ...
    foo_1 = Example(id=i, create_time=t, name="foo")
    foo_2 = Example(id=i, create_time=t, name="foo")
    foo_3 = Example(id=i, create_time=t, name="bar")
